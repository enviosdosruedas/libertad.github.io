...
export const noticias: NewsArticle[] = [
  ...
  },
  {
    ...
    extract: 'Tras una emocionante tanda de penales, el Gumarelo clasificó a la siguiente ronda de la copa y ya conoce a su próximo oponente.',
  ...
  },
  {
    ...
    extract: 'La prestigiosa escuela de fútbol de Club Libertad abre sus puertas para nuevos talentos. ¡Inscribe a tus hijos!',
